      ...
      <div class="layout-container">
        ...
        <div id="content-wrapper" class="d-flex flex-column"> <br>
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Barangay Certificate Requests History</h1>
                    ...
                    @foreach ($document_requests as $document_request)
                        <tr data-status="{{ $document_request->status }}" data-id="{{ $document_request->id }}">
                            ...
                            <td>
                                ...
                                @else
                                <form method="POST" action="{{ route('adminpage.deleteCertificate', $document_request->id) }}" onsubmit="return confirm('Are you sure you want to delete this document request?')">
                                  @csrf
                                  @method('DELETE')
