                ...
                <div class="row g-4 settings-section">
	                ...
	                <div class="col-12 col-md-8">
						...
						<form class="settings-form" action="{{ route('resident.store') }}" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label for="Photo" class="form-label"><b>Photo: </b><span class="text-danger">*</span></label>
									...
									<div class="form-group">
										...
										<input type="number" class="form-control" name="contact_number" required style="border: 0.5px solid #B0AEAE;" value="{{ old('contact_number') }}">
									...
									<div class="form-group">
										<label for="civil_status"><b>Gender:</b> <span class="text-danger">*</span></label>
										<div class="input-group">
						...
						<div class="form-group">
									...
									<div class="form-group">
										...
										<div id="otherPurposeField" style="display: none;">
											<label for="otherPurpose" class="form-label"><b>Other Purpose:</b></label>
