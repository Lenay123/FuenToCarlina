    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title">Barangay Indigency</h1>
			    <hr class="mb-4">
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                <h3 class="section-title">General</h3>
		                <div class="section-intro">This is a document issued by the barangay in the Philippines to certify that an individual or family qualifies as indigent or financially disadvantaged.</div>
	                </div>
		                ...
		                <div class="app-card app-card-settings shadow-sm p-4">
								<form class="settings-form" action="{{ route('resident.store') }}" method="POST">
									...
									<div class="form-group">
										...
										<input type="name" class="form-control" name="full_name" value="" required required style="border: 0.5px solid #B0AEAE;">
									</div>
									<div class="form-group">
										<label for="birthday">Birthday:<span class="text-danger">*</span></label>
										<div class="input-group">
										  <input type="date" class="form-control" name="birthday" required required style="border: 0.5px solid #B0AEAE;">
									...
									<div class="form-group">
										...
										<select class="form-control" name="address" required required style="border: 0.5px solid #B0AEAE;">
									...
									<div class="form-group">
										...
										<select class="form-control" name="civil_status" required required style="border: 0.5px solid #B0AEAE;">
									...
									<select id="document_type" name="document_type" class="form-control" required style="border: 0.5px solid #B0AEAE;">
